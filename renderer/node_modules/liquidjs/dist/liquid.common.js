/*
 * liquidjs@8.5.2, https://github.com/harttle/liquidjs
 * (c) 2016-2019 harttle
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = toValue;
                    return [4 /*yield*/, parseExp(str, ctx)];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = toValue;
                    return [4 /*yield*/, parseValue(str, ctx)];
                case 1: return [2 /*return*/, _a.apply(void 0, [_b.sent()])];
            }
        });
    });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        _a = instance;
                        _b = k;
                        return [4 /*yield*/, parseValue(v, ctx)];
                    case 2:
                        _a[_b] = _c.sent();
                        return [3 /*break*/, 1];
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        ...
                        arg = _a[_i];
                        if (!isKeyValuePair(arg)) return [3 /*break*/, 3];
                        _c = (_b = argv).push;
                        _d = [arg[0]];
                        return [4 /*yield*/, parseValue(arg[1], context)];
                    case 2:
                        _c.apply(_b, [_d.concat([_g.sent()])]);
                        return [3 /*break*/, 5];
                    case 3:
                        _f = (_e = argv).push;
                        return [4 /*yield*/, parseValue(arg, context)];
                    case 4:
                        _f.apply(_e, [_g.sent()]);
                        _g.label = 5;
                    case 5:
...
var Value = /** @class */ (function () {
    ...
    Value.prototype.value = function (ctx) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, parseExp(this.initial, ctx)];
                    case 1:
                        val = _b.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        val = _a.sent();
                        return [2 /*return*/, stringify(toValue(val))];
                }
            });
        });
    };
...
var For = {
    ...
    render: function (ctx, hash) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, parseExp(this.collection, ctx)];
                    case 1:
                        collection = _b.sent();
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 6:
                        ...
                        _a = hash;
                        _b = filepath;
                        return [4 /*yield*/, parseValue(this.with, ctx)];
                    case 7:
                        _a[_b] = _c.sent();
                        _c.label = 8;
...
function sortNatural(input, property) {
    ...
    if (property !== undefined) {
        return input.slice().sort(function (lhs, rhs) { return caseInsensitiveCmp(lhs[property], rhs[property]); });
    }
    return input.slice().sort(caseInsensitiveCmp);
}
...
var array = {
    ...
    'map': map,
    'reverse': function (v) { return v.slice().reverse(); },
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        paths = roots.map(function (root) { return _this.fs.resolve(root, file, _this.options.extname); });
                        _i = 0, paths_1 = paths;
                        _b.label = 1;
                    case 1:
                        ...
                        return [4 /*yield*/, this.fs.exists(filepath)];
                    case 2:
                        if (!(_b.sent()))
                            return [3 /*break*/, 4];
                        _a = this.parse;
