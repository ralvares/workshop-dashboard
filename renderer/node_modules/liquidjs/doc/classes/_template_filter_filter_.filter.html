	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="../modules/_template_filter_filter_.html">&quot;template/filter/filter&quot;</a>
				</li>
				<li>
					<a href="_template_filter_filter_.filter.html">Filter</a>
				</li>
			</ul>
			<h1>Class Filter</h1>
		</div>
		...
		<div class="col-8 col-content">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/harttle/liquidjs/blob/1e4f237/src/template/filter/filter.ts#L14">template/filter/filter.ts:14</a></li>
								</ul>
							</aside>
			...
			<section class="tsd-panel-group tsd-member-group tsd-is-private tsd-is-private-protected">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-private">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/harttle/liquidjs/blob/1e4f237/src/template/filter/filter.ts#L13">template/filter/filter.ts:13</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-private">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/harttle/liquidjs/blob/1e4f237/src/template/filter/filter.ts#L12">template/filter/filter.ts:12</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-private">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/harttle/liquidjs/blob/1e4f237/src/template/filter/filter.ts#L11">template/filter/filter.ts:11</a></li>
						</ul>
					</aside>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
					...
					<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
						<li class="tsd-signature tsd-kind-icon">render<span class="tsd-signature-symbol">(</span>value<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span>, context<span class="tsd-signature-symbol">: </span><a href="_context_context_.context.html" class="tsd-signature-type">Context</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/harttle/liquidjs/blob/1e4f237/src/template/filter/filter.ts#L24">template/filter/filter.ts:24</a></li>
								</ul>
							</aside>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
								...
								<li>
									<h5>context: <a href="_context_context_.context.html" class="tsd-signature-type">Context</a></h5>
								</li>
							</ul>
				...
				<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-static">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/harttle/liquidjs/blob/1e4f237/src/template/filter/filter.ts#L35">template/filter/filter.ts:35</a></li>
								</ul>
							</aside>
				...
				<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-static">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/harttle/liquidjs/blob/1e4f237/src/template/filter/filter.ts#L32">template/filter/filter.ts:32</a></li>
								</ul>
							</aside>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
			...
			<nav class="tsd-navigation secondary menu-sticky">
				...
				<ul class="current">
					<li class="current tsd-kind-class tsd-parent-kind-external-module">
						<a href="_template_filter_filter_.filter.html" class="tsd-kind-icon">Filter</a>
						<ul>
				...
				<ul class="after-current">
					<li class=" tsd-kind-type-alias tsd-parent-kind-external-module tsd-is-not-exported">
						<a href="../modules/_template_filter_filter_.html#filterarg" class="tsd-kind-icon">Filter<wbr>Arg</a>
					</li>
					<li class=" tsd-kind-type-alias tsd-parent-kind-external-module">
						<a href="../modules/_template_filter_filter_.html#filterargs" class="tsd-kind-icon">Filter<wbr>Args</a>
					</li>
					<li class=" tsd-kind-type-alias tsd-parent-kind-external-module tsd-is-not-exported">
						<a href="../modules/_template_filter_filter_.html#keyvaluepair" class="tsd-kind-icon">Key<wbr>Value<wbr>Pair</a>
					</li>
					<li class=" tsd-kind-function tsd-parent-kind-external-module tsd-is-not-exported">
						<a href="../modules/_template_filter_filter_.html#iskeyvaluepair" class="tsd-kind-icon">is<wbr>Key<wbr>Value<wbr>Pair</a>
					</li>
				</ul>
			</nav>
		</div>
